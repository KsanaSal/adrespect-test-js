...
export const buttonSecondary = (title) => {
    return /*html*/ `
    <button type="button" class="transition ease-in-out delay-150 bg-grayLight py-[12px] px-[24px] w-max rounded-[200px] text-[16px] text-primary hover:-translate-y-1 duration-300 hover:scale-105 hover:shadow-box hover:text-grayLight hover:bg-primary border-2 border-primary">
        ${title}
    </button>
    `;
};
